<?php
    ...
    if(empty($_SESSION['account'])){ // 如果沒有登入資料
    ...
    <body>
        ...
        <main class="BG">
            <section class="welcom-image">
                <strong class="welcom-image__title">存放技術之地-管理後臺</strong>
            ...
            <section class="wrapper">
                ...
                ?>
                    <div class="blog-box admin">
                        <div class="blog-box__title-box admin">
                            <div class="blog-box__title"><?php echo escape($row['Title']) ?></div>
                            <div class="blog-box__info admin">
                                <p class="blog-box__info__content"><?php echo escape($row['Create_at']) ?></p>
                            </div>
                            <?PHP
                            if(!empty($account)){ // 如果有登入資料
                            ?>
                                <form class="blog-box__edit-form admin" method="post" action="./edit_blog.php">
